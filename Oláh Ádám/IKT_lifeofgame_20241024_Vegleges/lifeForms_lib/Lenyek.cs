...
namespace lifeForms_lib
{
    public class Lenyek
    {
                        ...
                        if (regi_predator_jatekter_logika_Matrix[i, j].Lenytipusa == "predator")
                        {
                            ...
                            if (regi_predator_jatekter_logika_Matrix[i, j].lenyAllapota - lepes >= 0)
                            {
                                ...
                                switch (irany){
                                    ...
                                    case 5:
                                        //ball
                                        regi_predator_jatekter_logika_Matrix[i, j- lepes] = regi_predator_jatekter_logika_Matrix[i, j];
                                    ...
                                    case 10:
                                        //fel
                                        regi_predator_jatekter_logika_Matrix[i - lepes, j] = regi_predator_jatekter_logika_Matrix[i, j];
                                        regi_predator_jatekter_logika_Matrix[i, j] = null;
                                        break;
        ...
        #region predator szaporodás
        public Predator[,] PredatorSzaporodas(Predator[,] regi_predator_jatekter_logika_Matrix)
        {
            for (int i = 0; i < regi_predator_jatekter_logika_Matrix.GetLength(0); i++)
            {
                for (int j = 0; j < regi_predator_jatekter_logika_Matrix.GetLength(1); j++)
                {
                    try
                    {
                        ...
                        {
                            int irany = r.Next(1, 21);
                            if ((regi_predator_jatekter_logika_Matrix[i, j].lenyKaja + regi_predator_jatekter_logika_Matrix[i, j].lenyAllapota) >= 13)
                            {
                                Predator roka = new Predator();
                                SzuletettRokak += 1;
                                ...
                                switch (irany)
                                {
                                    ...
                                    case 5:
                                        //ball
                                        regi_predator_jatekter_logika_Matrix[i, j - 1] = roka;
                                        break;
                                    ...
                                    case 10:
                                        //fel
                                        regi_predator_jatekter_logika_Matrix[i - 1, j] = roka;
                                        break;
                        ...
                        if (regi_prey_jatekter_logika_Matrix[i, j].Lenytipusa == "prey")
                        {
                            ...
                            if (regi_prey_jatekter_logika_Matrix[i, j].lenyAllapota - lepes >= 0)
                            {
                                ...
                                switch (irany)
                                {
                                    ...
                                    case 5:
                                        //ball
                                        regi_prey_jatekter_logika_Matrix[i, j - lepes] = regi_prey_jatekter_logika_Matrix[i, j];
                                    ...
                                    case 10:
                                        //fel
                                        regi_prey_jatekter_logika_Matrix[i - lepes, j] = regi_prey_jatekter_logika_Matrix[i, j];
                                        regi_prey_jatekter_logika_Matrix[i, j] = null;
                                        break;
        ...
        #region prey szaporodás
        public Prey[,] PreySzaporodas(Prey[,] regi_prey_jatekter_logika_Matrix)
        {
            for (int i = 0; i < regi_prey_jatekter_logika_Matrix.GetLength(0); i++)
            {
                for (int j = 0; j < regi_prey_jatekter_logika_Matrix.GetLength(1); j++)
                {
                    try
                    {
                        if (regi_prey_jatekter_logika_Matrix[i, j].Lenytipusa == "prey")
                        {
                            ...
                            if (regi_prey_jatekter_logika_Matrix[i, j].lenyKaja + regi_prey_jatekter_logika_Matrix[i, j].lenyAllapota >= 9)
                            {
                                Prey nyul = new Prey();
                                SzuletettNyulak += 1;
                                ...
                                switch (irany)
                                {
                                    case 1:
                                        //ball
                                        regi_prey_jatekter_logika_Matrix[i, j - 1] = nyul;
                                        break;

                                    case 2:
                                        //fel
                                        regi_prey_jatekter_logika_Matrix[i - 1, j] = nyul;
                                        break;
